...
ALTER TABLE tb_usuario ADD cargo varchar(50);
ALTER TABLE tb_usuario ADD id_departamento int;
...
INSERT INTO tb_usuario (nome, login, senha, email, data_inclusao, login_inclusao, cargo, id_departamento)
VALUES (
